...
impl CopyTextureToSurface {
	pub fn new(render_system: &RenderSystem, texture_view: &wgpu::TextureView)->Self{
		...
		render_system.render_window.device.create_shader_module(&wgpu::include_wgsl!("copy_texture_to_surface_shader.wgsl"));

		let bind_group_layout = render_system.render_window.device.create_bind_group_layout(&wgpu::BindGroupLayoutDescriptor{
		...
		let pipeline_layout = render_system.render_window.device.create_pipeline_layout(&wgpu::PipelineLayoutDescriptor{
		...
		let render_pipeline = render_system.render_window.device.create_render_pipeline(&wgpu::RenderPipelineDescriptor{
	...
	pub fn create_bind_group(bind_group_layout: &wgpu::BindGroupLayout, device: &wgpu::Device, texture_view: &wgpu::TextureView, texture_sampler: &wgpu::Sampler) -> wgpu::BindGroup{
